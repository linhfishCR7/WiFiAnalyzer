...
Network analysis tool with WiFi scanning, signal strength monitoring, and security assessment

## 📱 App Information

- **Package Name:** `com.lehau.WiFiAnalyzer`
- **Category:** utilities
...
1. Clone this repository:
   ```bash
   git clone https://github.com/linhfishCR7/WiFiAnalyzer.git
   cd WiFiAnalyzer
   ```
